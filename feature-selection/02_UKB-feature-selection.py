...
name = f"{filepath}results/boruta/pAge_UKB_3k_dart_minMax_Boruta_vars_to_keep.csv"
...
# load best params
with open(f'{filepath}output/optuna/pAge_UKB_3k_dart_minMax_optuna_best_params_post_boruta.p', "rb") as f:
